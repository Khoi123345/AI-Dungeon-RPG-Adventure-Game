...
- **QUY TẮC CHUYỂN VỊ TRÍ**: Khi quét thấy vật phẩm `"item_obsidian_key"` trong danh sách `INVENTORY` của người chơi, AI **BẮT BUỘC** phải cung cấp ít nhất 1 Lựa chọn (Choice) để người chơi tiến sang địa điểm tiếp theo: `"label": "Trèo lên Đỉnh Núi Hắc Diệu Thạch"`, `"nextNodeId": "obsidian_peaks"`.
...
- **QUY TẮC CHUYỂN VỊ TRÍ**: Khi quét thấy vật phẩm `"item_dragon_blood_key"` trong danh sách `INVENTORY` của người chơi, AI **BẮT BUỘC** phải cung cấp ít nhất 1 Lựa chọn (Choice) để người chơi tiến sang địa điểm tiếp theo: `"label": "Tiến vào Tổ Rồng"`, `"nextNodeId": "dragon_nest"`.
