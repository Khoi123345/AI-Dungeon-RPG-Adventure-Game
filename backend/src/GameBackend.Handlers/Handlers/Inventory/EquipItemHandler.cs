...
{
    /// <summary>Lambda handler cho POST /inventory/{characterId}/equip</summary>
    public class EquipItemHandler
    {
        ...
        public async Task<APIGatewayProxyResponse> Handler(APIGatewayProxyRequest request, ILambdaContext context)
        {
            ...
            try
            {
                ...
                var body = JsonSerializer.Deserialize<EquipItemRequest>(
                    request.Body ?? "{}",
                ...
                var result = await _inventoryService.EquipItemAsync(characterId, body.inventoryId, body.itemId);
            ...
            {
                context.Logger.LogLine($"[EquipItemHandler] Error: {ex.Message} {ex.StackTrace}");
