...
- **Quái thường luôn khả dụng:** Dù đã mở `boss_room`, khi chưa chọn đánh Boss AI vẫn phải cho phép đánh Oan Hồn Bóng Tối (`mob_shadow_spirit`) hoặc Tàn Dư Hư Không (`mob_void_remnant`). Lựa chọn đánh quái thường không được đổi thành Shadow Demon.
