...
namespace Infrastructure
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var storageStack = new Stacks.StorageStack(app, "GameStorageStack", new StackProps { Env = env });
            var lambdaStack = new Stacks.LambdaStack(app, "GameLambdaStack", dbStack, cognitoStack, storageStack, new StackProps { Env = env });
